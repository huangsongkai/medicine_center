...
<script type="text/javascript">
    ...
    var pageParas ={
        formInit :[
                    {name:"expertsLogId", placeholder:"expertsLogId"} ,
                                ...
                                {name:"createUser", placeholder:"createUser"} ,
                                {name:"editionnum", placeholder:"editionnum"}                             ],
        formExtend :[
