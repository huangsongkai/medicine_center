...
<html>
  ...
  <jsp:include page="../template.jsp" flush="true"></jsp:include>
    ...
    var url = "/d2/experts/"+id;
    var selector = {
      gender:["男", "女"],
      category:["组长", "监管", "检验", "临床"],
      categoryTwo:{
        "组长":["注射剂", "中药", "化药", "医用氧"],
        "监管":["注射剂", "中药", "化药", "医用氧"],
        "检验":["中药", "化药"],
    ...
    var pageParas ={
      formInit :[
        ...
        {name:"phone"} ,
        {name:"bacteria"} ,
        {name:"selectGroup", selectGroup:[{name:"category", alias:"分类", type:"select"}, {name:"categoryTwo", alias:"科目", type:"select"}], selector:selector} ,
        {name:"remarks"} ,
        {name:"source"}                             
      ],
      formExtend :[
        ...
        //{name:"categoryTwo", alias:"科目", type:"select", options:selector.categoryTwo} ,
