...
import com.medicineCenter.model.dataObject.ExpertsLogExample.Criteria;
import com.medicineCenter.model.dataObject.ExpertsLogExample.Criterion;
import com.medicineCenter.model.dataObject.ExpertsLogExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ExpertsLogSqlProvider {
     ...
     */
    public String countByExample(ExpertsLogExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("experts_log");
     ...
     * @mbggenerated Mon Jan 02 16:23:31 CST 2017
     */
    public String deleteByExample(ExpertsLogExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("experts_log");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbggenerated Mon Jan 02 16:23:31 CST 2017
     */
    public String insertSelective(ExpertsLog record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("experts_log");
        
        if (record.getExpertsLogId() != null) {
            sql.VALUES("experts_log_id", "#{expertsLogId,jdbcType=INTEGER}");
        }
        ...
        if (record.getEditionnum() != null) {
            sql.VALUES("editionNum", "#{editionnum,jdbcType=INTEGER}");
        }
     ...
     * @mbggenerated Mon Jan 02 16:23:31 CST 2017
     */
    public String selectByExample(ExpertsLogExample example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("experts_log_id");
        } else {
            sql.SELECT("experts_log_id");
        }
        ...
        sql.SELECT("editionNum");
        sql.FROM("experts_log");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ExpertsLog record = (ExpertsLog) parameter.get("record");
        ExpertsLogExample example = (ExpertsLogExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("experts_log");
        
        if (record.getExpertsLogId() != null) {
            sql.SET("experts_log_id = #{record.expertsLogId,jdbcType=INTEGER}");
        }
        ...
        if (record.getEditionnum() != null) {
            sql.SET("editionNum = #{record.editionnum,jdbcType=INTEGER}");
        }
     ...
     * @mbggenerated Mon Jan 02 16:23:31 CST 2017
     */
    public String updateByPrimaryKeySelective(ExpertsLog record) {
        SQL sql = new SQL();
        sql.UPDATE("experts_log");
        ...
        if (record.getEditionnum() != null) {
            sql.SET("editionNum = #{editionnum,jdbcType=INTEGER}");
        }
        
        sql.WHERE("experts_log_id = #{expertsLogId,jdbcType=INTEGER}");
     ...
     * @mbggenerated Mon Jan 02 16:23:31 CST 2017
     */
    protected void applyWhere(SQL sql, ExpertsLogExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
