...
import com.medicineCenter.model.dataObject.ExpertsInfoExample.Criteria;
import com.medicineCenter.model.dataObject.ExpertsInfoExample.Criterion;
import com.medicineCenter.model.dataObject.ExpertsInfoExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ExpertsInfoSqlProvider {
     ...
     */
    public String countByExample(ExpertsInfoExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("experts_info");
     ...
     * @mbggenerated Tue Oct 18 10:07:52 CST 2016
     */
    public String deleteByExample(ExpertsInfoExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("experts_info");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbggenerated Tue Oct 18 10:07:52 CST 2016
     */
    public String insertSelective(ExpertsInfo record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("experts_info");
        ...
        if (record.getCategoryOne() != null) {
            sql.VALUES("category_one", "#{categoryOne,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Tue Oct 18 10:07:52 CST 2016
     */
    public String selectByExample(ExpertsInfoExample example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("leader");
        sql.SELECT("bacteria");
        sql.SELECT("category_one");
        sql.SELECT("category_two");
        sql.SELECT("source");
        sql.SELECT("CREATE_TIME");
        sql.FROM("experts_info");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ExpertsInfo record = (ExpertsInfo) parameter.get("record");
        ExpertsInfoExample example = (ExpertsInfoExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("experts_info");
        ...
        if (record.getCategoryOne() != null) {
            sql.SET("category_one = #{record.categoryOne,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Tue Oct 18 10:07:52 CST 2016
     */
    public String updateByPrimaryKeySelective(ExpertsInfo record) {
        SQL sql = new SQL();
        sql.UPDATE("experts_info");
        ...
        if (record.getCategoryOne() != null) {
            sql.SET("category_one = #{categoryOne,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Tue Oct 18 10:07:52 CST 2016
     */
    protected void applyWhere(SQL sql, ExpertsInfoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
