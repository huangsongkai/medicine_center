...
public class MessageUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 电话号码字符串，中间用英文逗号间隔
          StringBuffer mobileString=new StringBuffer("17603678749");
        // 内容字符串
...
//                "中心纪委联系人：尹大志，电话：0451-51983680\n");
        ...
        StringBuffer contextString=new StringBuffer("【审核查验中心】"+
                123+"检查员：\n"+
                "您好! 黑龙江省食品药品审核查验中心拟邀请您于"+123+"至"+123+"期间参加"+123+"检查工作，检查工作地点："+123+"。" +
                ...
                "三、请您于"+123+" 8:00前到达指定工作地点。如需召开检查前工作动员会，另行通知。\n");
        // 签名
        String sign="";
        // 追加发送时间，可为空，为空为及时发送
        String stime="";
